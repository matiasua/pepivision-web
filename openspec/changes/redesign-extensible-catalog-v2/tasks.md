...
- [ ] 7.4 Definir `quoteOptionsSchema` (Zod, versionado) y la tabla de compatibilidad por categoría (Lentes ópticos vs. Lentes de sol) descrita en design.md. **Fuera de alcance de este bloque** (motor de compatibilidades — pertenece a la Fase 9, explícitamente excluida de esta pasada).
